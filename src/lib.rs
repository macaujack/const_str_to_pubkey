//! # const_str_to_pubkey
//!
//! A Rust library that helps developers derive a **constant** `Pubkey` with a **constant** string. (Base58 decode algorithm is the same with [`bs58` crate](https://docs.rs/bs58/latest/bs58/))
//!
